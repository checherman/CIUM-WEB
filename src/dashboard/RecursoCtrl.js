...
(function() {
  ...
  angular
    .module("App")
    .controller("recursoController", function (
      $scope,
      $http,
      $window,
      $location,
      ...
      $scope.getDimension = function (nivel, c) {
        ...
        if ($scope.filtro.tipo == "Recurso") url = "/recursoDimension";
        $scope.datos[c] = [];
        CrudDataApi.lista(
  ...
  angular
    .module("App")
    .controller("pieRecursoController", function(
      $scope,
      $http,
      $window,
      $location,
  ...
  angular
    .module("App")
    .controller("criterioRecursoController", function(
      $scope,
      $localStorage,
      $stateParams,
      $http,
  ...
  angular
    .module("App")
    .controller("alertaRecursoController", function(
      $scope,
      $localStorage,
      $stateParams,
      $http,
  ...
  angular
    .module("App")
    .controller("globalRecursoController", function(
      $scope,
      $http,
      $window,
      $location,
  ...
  angular
    .module("App")
    .controller("gaugeRecursoController", function(
      $scope,
      $http,
      $window,
      $location,
